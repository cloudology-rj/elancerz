...
const StyledModal = styled.div`
    ...
    .overlay.active{
        ...
        .card{
            ...
            box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.16), 0px 1px 1px rgba(14, 19, 44, 0.04);
            border-radius: 12px;
            display: flex;
    ...
    return (
        <StyledModal>
            ...
            <div className={props.modalActive ? 'overlay active' : 'overlay'}>
                <div className="modal">
                    <div className="card">
                        <ButtonOpacity className="close-btn" onClick={() => props.setModalActive(!props.modalActive)}>
